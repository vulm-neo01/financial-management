...
import { wallets } from "./menuconfig/wallets";
import { exchanges } from "./menuconfig/exchanges";
import { budgets } from "./menuconfig/budgets";
import { savings } from "./menuconfig/savings";
import { allLoanAndDebt } from "./menuconfig/all-loan-debt";
import { groups } from "./menuconfig/group-wallet";
...
menuIconMap.set("WalletIcon", <WalletIcon />);
menuIconMap.set("GroupIcon", <GroupIcon />);
menuIconMap.set("SavingsIcon", <SavingsIcon />);
menuIconMap.set("CurrencyExchangeIcon", <CurrencyExchangeIcon />);
menuIconMap.set("LeaderboardIcon", <LeaderboardIcon />);
menuIconMap.set("SwapHorizIcon", <SwapHorizIcon />);
